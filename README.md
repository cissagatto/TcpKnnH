...
## How to cite 
@misc{Gatto2021, author = {Gatto, E. C.}, title = {Test Hybrid Partitions using Communities Detection Methods for Multilabell Classification}, year = {2022}, publisher = {GitHub}, journal = {GitHub repository}, howpublished = {\url{https://github.com/cissagatto/TCP-KNN-H-Clus}}}
...
## RUN
To run the code, open the terminal, enter the *~/TCP-KNN-H-Clus/R* folder, and type
...
```
Rscript tcp.R "~/TCP-KNN-H-Clus/config-files/jaccard/Macro-F1/ctjma-GpositiveGO.csv"
```
